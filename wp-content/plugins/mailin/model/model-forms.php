...
if(!class_exists('SIB_Forms')) {
    class SIB_Forms
    {
        ...
        public static function alterTable()
        {
            ...
            $alter_query = "ALTER TABLE sib_model_forms
        ...
        public static function getForm($frmID = 'new')
        {
            ...
            if ($frmID == 'new') {
                ...
                $query = 'select * from ' . self::table_name . ' where id=' . $frmID . ';';
        ...
        public static function addForm($formData)
        {
            ...
            $query .= '(title,html,css,dependTheme,listID,templateID,isOpt,isDopt,redirectInEmail,redirectInForm,successMsg,errorMsg,existMsg,invalidMsg,attributes,date,gCaptcha,gCaptcha_secret,gCaptcha_site) ';
        ...
        '{$formData['successMsg']}','{$formData['errorMsg']}','{$formData['existMsg']}','{$formData['invalidMsg']}','{$formData['attributes']}','{$current_date}','{$formData['gcaptcha']}','{$formData['gcaptcha_secret']}' ,'{$formData['gcaptcha_site']}')";
            $wpdb->query($query);
        ...
        successMsg='{$formData['successMsg']}',errorMsg='{$formData['errorMsg']}',existMsg='{$formData['existMsg']}',invalidMsg='{$formData['invalidMsg']}',date='{$current_date}',attributes='{$formData['attributes']}',gCaptcha='{$formData['gcaptcha']}',gCaptcha_secret='{$formData['gcaptcha_secret']}' ,gCaptcha_site='{$formData['gcaptcha_site']}' ";
