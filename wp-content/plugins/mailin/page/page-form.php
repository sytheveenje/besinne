...
if(!class_exists('SIB_Page_Form'))
{
    class SIB_Page_Form
    {
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div id="sib-field-form" class="panel panel-default row form-field"
                                            ...
                                            <div class="row small-content2"
                                                ...
                                                <input type="radio" name="sib_add_captcha" class="sib-add-captcha" value="1" <?php checked($formData['gCaptcha'], '1'); ?>><label class="sib-add-captcha-label">Yes</label>
                                                <input type="radio" name="sib_add_captcha" class="sib-add-captcha" value="0" <?php checked($formData['gCaptcha'], '0'); ?>><label class="sib-add-captcha-label">No</label>
                                            </div>
                                            ...
                                            <div class="row small-content2 sib-captcha-key" style="display: none;">
                                                ...
                                                <?php SIB_Page_Home::get_narration_script(__('Add Captcha', 'sib_lang'), __('Please click where you want to insert the captcha box and click on this button. By default, the box will be added at top.', 'sib_lang')); ?>
                                            </div>
                                        </div>
        ...
        public static function save_setting_subscription()
        {
            ...
            $form_name = $_POST['sib_form_name'];
            $form_html = stripslashes($_POST['sib_form_html']);
            $list_ids = maybe_serialize($_POST['list_id']); // array()
            $dependTheme = $_POST['sib_css_type'];
            $customCss = $_POST['sib_form_css'];
            $gCaptcha = $_POST['sib_add_captcha'];
