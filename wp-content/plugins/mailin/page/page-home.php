...
if(!class_exists('SIB_Page_Home'))
{
    class SIB_Page_Home
    {
            ...
            <div id="main-content" class="sib-content">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12 row" style="padding-top: 10px;">
                            ...
                            <div class="col-md-6 row" style="margin-bottom: 10px;">
                                ...
                                <a <?php echo $isSynced != '0' ? 'disabled' : ''; ?> id="sib-sync-btn" class="col-md-4 btn btn-primary" style="margin-top: 28px; " name="<?php echo __('Users Synchronisation', 'sib_lang'); ?>" href="#"><?php _e('Sync my users', 'sib_lang'); ?></a>
                            </div>
                        </div>
                ...
                <div class="panel panel-default row small-content">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="">
                            <p class="col-md-4 text-left" style="font-size: 13px; font-style: italic;"><?php printf(__('%s Explore our resource %s to learn more about SendinBlue Automation', 'sib_lang'), '<a href="https://resources.sendinblue.com/en/introduction-marketing-automation/?utm_source=wordpress_plugin&utm_medium=plugin&utm_campaign=module_link">', '</a>'); ?></p>
                            <div class="col-md-3">
                                <button type="button" id="validate_ma_btn" class="col-md-12 btn btn-primary"><span class="sib-spin"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i>&nbsp;&nbsp;</span><?php _e('Validate', 'sib_lang'); ?></button>
                            </div>
                            <div class="col-md-5">
                            </div>
                        </div>
        ...
        public static function ajax_sync_users(){
            ...
            if($result['code'] == 'success') update_option('sib_sync_users', '1');
            wp_send_json($result);
        }
